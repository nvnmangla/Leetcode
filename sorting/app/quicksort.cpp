...
/** @brief Worst Case vs Average Running Time
                ...
                • However, it is very efficient on average – its expected
   running time is Θ(𝑛lg𝑛), with small constant factors. • This usually makes
   quicksort the best practical choice for sorting.
*/
